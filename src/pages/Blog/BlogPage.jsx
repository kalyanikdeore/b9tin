                ...
                {blogs.map((blog, index) => (
                  ...
                  >
                    <Link to={`/blog/${blog.slug}`}>
                      ...
                      />
                      <div className="p-6">
                        <span className="inline-block px-3 py-1 text-xs font-semibold text-purple-800 bg-purple-100 rounded-full mb-2">
                          {blog.category}
                        </span>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm font-medium text-purple-600 hover:text-purple-700 transition-colors">
                            Read More →
                          </span>
                        </div>
                      </div>
