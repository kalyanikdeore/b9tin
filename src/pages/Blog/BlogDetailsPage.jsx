  ...
  >
    ...
    <div className="border-t border-gray-200 pt-6">
      ...
      <form className="space-y-4">
        ...
        <button
          type="submit"
          className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-6 rounded-md transition-colors"
        >
          Post Comment
        </button>
      </form>
  ...
  <div className="mb-8">
    ...
    <div className="relative">
      <input
        ...
        className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500"
      />
      <button className="absolute right-3 top-2.5 text-gray-400 hover:text-purple-500">
