...
export default function TherapyPlatform() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-100 p-6">
      ...
      <main className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:flex-1 p-8 md:p-12 bg-gray-700 text-white">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg
                    className="h-6 w-6 text-gray-300 mr-3 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
