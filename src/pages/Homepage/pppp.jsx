...
const ChronicHealth = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-400 to-purple-700 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-10 relative z-10">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl p-10 shadow-2xl">
          ...
          <div className="bg-gradient-to-br from-pink-400 to-pink-600 text-white p-8 rounded-xl mb-10 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
            <div className="global-stat-card pulse bg-gradient-to-br from-green-400 to-teal-600 text-white p-8 rounded-xl text-center shadow-xl relative overflow-hidden">
              <div className="text-4xl font-extrabold mb-2">133M</div>
              <div className="text-base font-medium">
                Americans with chronic conditions
              </div>
            </div>
            <div className="global-stat-card bg-gradient-to-br from-green-400 to-teal-600 text-white p-8 rounded-xl text-center shadow-xl relative overflow-hidden">
