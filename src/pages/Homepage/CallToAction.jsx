...
const CallToAction = () => {
  ...
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-300 to-gray-300  bg-opacity-60"></div>

      {/* Content */}
      <div className="relative z-10 text-center text-gray-900 px-4 max-w-4xl">
